  ...
  <div class="p-3 fixed-bottom mb-4">
    <nav class="navbar bar">
      <div class="container-fluid">
        <ul class="navbar-nav">
          <li class="nav-item">
            <RouterLink class="nav-link active selected" to="/">
          ...
          <li class="nav-item">
            <RouterLink class="nav-link active selected" to="/departures/:id">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                <!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                <path
              ...
              <!-- Departures --></RouterLink
            >
          </li>
          <li class="nav-item">
            <RouterLink class="nav-link active selected" to="/clear">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                <!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                <path
          ...
          <li class="nav-item">
            <RouterLink class="nav-link active selected" to="/profile">
